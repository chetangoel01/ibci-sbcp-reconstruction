...
app = modal.App("phase2-transformer-v2")

data_vol = modal.Volume.from_name("phase2-data", create_if_missing=True)
output_vol = modal.Volume.from_name("phase2-outputs-v2", create_if_missing=True)
...
def main():
    ...
    print("  modal volume get phase2-outputs-v2 checkpoints/best_transformer.pt .")
    print("  modal volume get phase2-outputs-v2 results/submission_transformer.csv .")
